...
@router.get("/workflows/{workflow_id}", dependencies=[Depends(permission_dependency("read"))])
...
@router.post("/workflows/{workflow_id}/resume", dependencies=[Depends(permission_dependency("admin"))])
...
@router.get("/agents/runs", dependencies=[Depends(permission_dependency("read"))])
def agent_runs(
...
@router.get("/validation/results", dependencies=[Depends(permission_dependency("read"))])
